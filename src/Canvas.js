...
export const App = ({ position = [0, 0, 2.5], fov = 25 }) => {
  ...
  return <div style={styles.topDiv}>
    
  <Canvas ref={canvasRef} shadows   gl={{ preserveDrawingBuffer: true }} eventSource={document.getElementById('root')} eventPrefix="client">
    ...
    <CameraRig>
      {/* <Backdrop /> */}
      {/* <Center> */}
        <Shirt meshRef={meshRef} sendCamera={(cm) => setCamera(cm)} />
        
      {/* </Center> */}
    </CameraRig>
</Canvas>
<ToolBar meshRef={meshRef} camera={camera} />
</div>
...
function Shirt(props) {
  ...
  return (
    ...
    <mesh ref={props.meshRef} castShadow geometry={nodes.T_Shirt_male.geometry} material={materials.lambert1} material-roughness={1} {...props} dispose={null}>
